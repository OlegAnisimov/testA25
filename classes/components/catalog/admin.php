<?php
	...
	class CatalogAdmin implements iUmiRegistryInjector {
		...
		public function tree() {
			...
			$this->setTranslatorOption('field-name-black-list', ['trade_offer_list']);
		...
		public function config() {
			$params = [
				'config' => [
					'int:per_page' => (int) $this->getRegistryValue('per_page'),
					'bool:is_filter_virtual_copies' => (bool) $this->getRegistryValue('is_filter_virtual_copies'),
					'bool:disable_generate_vendor_code' => (bool) $this->getRegistryValue('disable_generate_vendor_code'),
					'bool:disable_unique_vendor_code' => (bool) $this->getRegistryValue('disable_unique_vendor_code'),
					'bool:disable_missing_products' => (bool) $this->getRegistryValue('disable_missing_products')
				]
			];
			...
			if ($this->isSaveMode()) {
				...
				$this->setRegistryValue('per_page',  $config['int:per_page']);
				$this->setRegistryValue('is_filter_virtual_copies',  $config['bool:is_filter_virtual_copies']);
				$this->setRegistryValue('disable_generate_vendor_code',  $config['bool:disable_generate_vendor_code']);
				$this->setRegistryValue('disable_unique_vendor_code',  $config['bool:disable_unique_vendor_code']);
				$this->setRegistryValue('disable_missing_products', $config['bool:disable_missing_products']);
				$this->chooseRedirect();
			}
