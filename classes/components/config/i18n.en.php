<?php
	...
	$i18n = [
		...
		'js-label-not-last-version-warning-text' => 'You do not use the latest version of the UMI.CMS system. Installed modules may not work correctly. We recommend that you update the version of UMI.CMS or make backups.',
