<?php
	...
	class itemDiscount extends discount {
		...
		public function validate(iUmiHierarchyElement $element) {
			...
			$isDiscountWithoutRulesForAllGoods = Service::Registry()
				->get('//modules/emarket/is-discount-without-rules-works-for-all-goods');

			return $isDiscountWithoutRulesForAllGoods ? true : $validateCount > 0;
		}
