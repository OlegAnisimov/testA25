<?php
	...
	$COMPONENTS[] = './classes/components/exchange/events.php';
	...
	$COMPONENTS[] = './classes/components/exchange/classes/AdminSettingsManager.php';
	$COMPONENTS[] = './classes/components/exchange/classes/iAdminSettingsManager.php';
