<?php
	 ...
	 * Модуль отвечает за:
	 *
	 * 1) Интеграцию с Яндекс.Вебмастер;
	 * 2) Работу с seo настройками доменов;
	 * 3) Получение списка битых ссылок;
	 * 4) Получения списка страниц с незаполненными meta тегами;
	 * 5) Обновление карты сайта для доменов;
