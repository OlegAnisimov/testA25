<?php
	...
	class Admin implements \iModulePart {
				...
				'nodes:section' => [
					...
					[
						...
						'nodes:history' => [
							...
							$this->prepareHistory(
								'sqi',
								getLabel('label-yandex-sqi-history'),
								[
									$this->prepareHistoryDataSet(
										'all', getLabel('label-yandex-all'), $webMaster->getSqiHistory($siteId)
									)
								]
							),
							$this->prepareHistory(
		 ...
		 * @throws \publicAdminException
		 */
		public function deleteSite($siteId = null) {
			$siteId = $siteId ?: $this->request->Post()->get('site_id');
...
HTML;
		...
		private function getNotAddedSiteShortInfo(\iDomain $domain) {
			return [
				...
				'verify_code' => 'NONE',
				'sqi' => getLabel('label-yandex-site-option-null-value'),
		...
		private function getSiteListConfig() {
			return [
				...
				'fields' => [
					...
					[
						'name' => 'sqi',
						'title' => getLabel('label-yandex-site-sqi'),
						'type' => 'integer',
						'editable' => 'false',
						'filterable' => 'false',
						'sortable' => 'false'
