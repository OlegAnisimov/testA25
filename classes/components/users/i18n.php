<?php
	...
	$i18n = [
		...
		'error-not-verified-email' => 'Почта на сервисе, через который выполняется вход, не подтверждена',
		...
		'perms-users-delete' => 'Права на удаление пользователей, групп и авторов',
		...
		'mail-template-users-variable-user_id' => 'Id пользователя',
		'mail-template-users-variable-login' => 'Логин',
		'mail-template-users-variable-domain' => 'Домен',
		'mail-template-users-variable-restore_link' => 'Ссылка восстановления пароля',
		'mail-template-users-variable-email' => 'Электронная почта',
		'mail-template-users-variable-activate_link' => 'Ссылка активации',
		'mail-template-users-variable-password' => 'Пароль',
		'mail-template-users-variable-fname' => 'Имя',
		'mail-template-users-variable-lname' => 'Фамилия',
		'mail-template-users-variable-father_name' => 'Отчество',
	];
