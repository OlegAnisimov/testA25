<?php
	...
	interface iFactory {
		 ...
		 * @example:
		 *
		 * Set-Cookie: foo=bar; expires=Thu, 01-Jan-1970 00:00:01 GMT; Max-Age=-1491548883; path=/; domain=test.com;
		 *     secure; httponly
		 *
		 * @return iCookie
		 */
		 ...
		 * @param string|null $domain домен (поддомен)
		 * @return iFactory
		 */
		...
		/**
		 * Устанавливает значение доступа к куке с других доменов по умолчанию
