<?php
	...
	interface iFacade {
		...
		/**
		 * Выводит в буффер данные в xml формате
		...
		/**
		 * Выводит в буффер данные в html формате
		 * @param string $html данные
		 * @param string $status статус ответа
		 */
		public function printHtml($html, $status = '200 OK');

		/**
		 * Выводит в буффер изображение
		 * @param \iUmiFile $image изображение
		 * @param string $status статус ответа
		 */
