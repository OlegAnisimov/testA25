<?php
	...
	interface iSession extends \iMapContainer {
		...
		/**
		 * Возвращает параметр "Expires" для сессионной куки
		 * @return int
		 */
		public function getCookieLifeTime();

		/**
		 * Возвращает параметр "Path" для сессионной куки
		 * @return string
		 */
		public function getCookiePath() : string;

		/**
		 * Возвращает параметр "Domain" для сессионной куки
		 * @return string|null
		 */
		public function getCookieDomain() : ?string;

		/**
		 * Возвращает параметр "Secure" для сессионной куки
		 * @return bool
		 */
		public function getCookieSecureFlag() : bool;

		/**
		 * Возвращает параметр "HttpOnly" для сессионной куки
		 * @return bool
		 */
		public function getCookieHttpOnly() : bool;

		/**
		 * Возвращает параметр "SameSite" для сессионной куки
		 * @return string
		 */
