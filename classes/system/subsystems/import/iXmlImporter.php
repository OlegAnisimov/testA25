<?php
	...
	interface iXmlImporter {
		...
		/**
		 * Устанавливает режим записи лога в файл
		 * @param bool $writeLogFile
		 * @return $this
		 */
		public function setWriteLogFile(bool $writeLogFile) : iXmlImporter;

		/**
		 * Устанавливает формат исходного файла импорта
		...
		/**
		 * Устанавливает идетификатор сценария импорта
		 * @param int $importId
		 * @return $this
		 */
		...
		/**
		 * Устанавливает откуда вызван импорт
