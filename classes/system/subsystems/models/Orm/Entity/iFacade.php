<?php
	...
	interface iFacade {
		 ...
		 * ]
		 *
		 * @param int|null $offset смешение части списка
		...
		/**
		 * Возвращает список сущностей с параметрами, удовлетворяющими карте фильтрации
		...
		/**
		 * Возвращает количество сущностей с параметрами, удовлетворяющими карте соответствия
		 * @param array $equalityMap карта соответствия
		 * @return int
		 * @throws \ErrorException
		 * @throws \ReflectionException
		...
		/**
		 * Возвращает количество сущностей с параметрами, удовлетворяющими карте фильтрации
		 * @param array $map карта фильтрации
		 * @return int
		 * @throws \ErrorException
		 * @throws \ReflectionException
		 ...
		 * @param array $equalityMap карта соответствия
		 * @return int количество удаленный сущностей
		 * @throws \ErrorException
		 * @throws \ReflectionException
		 * @throws \databaseException
		 */
