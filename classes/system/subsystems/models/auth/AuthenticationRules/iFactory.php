<?php
	...
	interface iFactory {
		...
		/**
		 * Создает правило аутентификации пользователя по логину и токену авторизации
		 * @param string $login логин
		...
		/**
		 * Создает правило аутентификации пользователя по идетификтору пользователя в 
		 * социальной сети и названию провайдера данных пользователя (социальной сети)
		 * @param string $uid логин
		 * @param string $provider название провайдера данных пользователя (социальной сети)
		 * @return iRule
		 */
