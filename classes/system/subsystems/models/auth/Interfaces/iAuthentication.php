<?php
	...
	interface iAuthentication {
		...
		/**
		 * Аутентифицирует пользователя по идентификатор или логину пользователя и 
		 * названию провайдера данных пользователя (социальной сети)
		 * @param string $uid идентификатор или логин пользователя в социальной сети
		 * @param string $provider название провайдера данных пользователя (социальной сети)
		 * @param string|null $service сервис авторизации
		 * @return int идентификатор пользователя, если аутентификация прошла удачно
		 * @throws WrongCredentialsException
		 * @throws AuthenticationException
		 */
		...
		/**
		 * Аутентифицирует пользователя по логину и токену авторизации.
		 * @return int|bool идентификатор пользователя, если аутентификация прошла удачно
		 * @throws WrongCredentialsException
		 */
