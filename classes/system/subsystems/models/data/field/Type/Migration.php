	...
	class Migration implements iMigration {
		...
		private function process(array $target, $index) {
			...
			if (!$type instanceof \iUmiObjectType) {
				throw new \ErrorException('Incorrect type guid given: ' . var_export($target['type-guid'], true));
			}
			...
			if (!$field instanceof \iUmiField) {
				throw new \ErrorException('Incorrect field name given: ' . var_export($target['field'], true));
			}
