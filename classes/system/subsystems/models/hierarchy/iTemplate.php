<?php
	...
	interface iTemplate extends iUmiEntinty {
		...
		/**
		 * Возвращает директорию с кастомами для шаблонов
		 * @return string|bool
		 */
		...
		/**
		 * Возвращает количество страниц с заданным именем, которые принадлежат текущему шаблону
		 * @param string|null $name фильтруемое имя страниц
		 * @return int
		...
		/**
		 * Определяет есть ли страницы, использующие шаблон
		 * @return bool
		 * @throws databaseException
		 */
		...
		/**
		 * Определяет есть ли страницы с заданным именем, которые принадлежат текущему шаблону
		 * @param string|null $name фильтруемое имя страниц
		 * @return bool
		 * @throws databaseException
		 */
		...
		/**
		 * Возвращает список страниц с заданным именем, который принадлежит текущему шаблону
		 * @param string|null $name фильтруемое имя страниц
		 * @param int $limit максимальное количество получаемых элементов
		 * @param int $offset смещение, относительно которого будет производиться выборка элементов
		 * @return iUmiHierarchyElement[]
