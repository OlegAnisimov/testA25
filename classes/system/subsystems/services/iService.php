<?php
	...
	interface iService {
		 ...
		 * @return \UmiCms\Classes\System\Utils\SiteMap\iUpdater
		 */
		...
		/**
		 * Возвращает загрузчик файлов
		 * @return \UmiCms\Classes\System\Entities\File\Uploader
		 */
		public static function FileUploader();

		/**
		 * Возвращает загрузчик изображений
		 * @return \UmiCms\Classes\System\Entities\Image\Uploader
		 */
		...
		/** @return \UmiCms\System\Admin\iSkin */
		public static function AdminSkin();

		/**
		 * Возвращает экземпляр фасада записей об обработке ответа с ошибкой
		 * @return \UmiCms\System\Response\Error\Entry\iFacade;
		 */
		public static function ResponseErrorEntryFacade();

		/**
		 * Возвращает экземпляр роутера
		 * @return \UmiCms\Classes\System\Routing\iRouter
		 */
		public static function Router();

		/**
		 * Возвращает экземпляр фабрики контроллеров
		 * @return \UmiCms\Classes\System\Controllers\iFactory
		 */
		public static function ControllerFactory();

		/**
		 * Возвращает экземпляр фасада агентов пагинации
		 * @return \UmiCms\Classes\System\PageNum\Agent\iFacade
		 */
		public static function PageNumAgentFacade();

		/**
		 * Возвращает экземпляр фабрики шаблонизаторов
		 * @return \UmiCms\Classes\System\Template\Engine\iFactory
		 * @throws \Exception
		 */
		public static function TemplateEngineFactory();

		/**
		 * Возвращает экземпляр клиента API Google.OAuth
		 * @return iOAuth
		 * @throws \Exception
		 */
		...
		/**
		 * Возвращает экземпляр html парсера
		 * @return iParser
		 * @throws \Exception
		 */
		...
		/**
		 * Возвращает экземпляр фабрики обработчиков событий
		 * @return iEventHandlerFactory
		 * @throws \Exception
		 */
		public static function EventHandlerFactory();

		/**
		 * Возвращает экземпляр контроллера событий
		...
		/**
		 * Возвращает экземпляр фабрики исполнителей обработчиков событий
		 * @return iEventHandlerExecutorFactory
		 * @throws \Exception
		 */
		public static function EventHandlerExecutorFactory() : iEventHandlerExecutorFactory;

		/**
		 * Возвращает эклемпляр фабрики простых http клиентов
		 * @return iLiteHttpClientFactory
		 * @throws \Exception
		 */
