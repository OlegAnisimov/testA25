<?php
	...
	class loginzaAPI {
		...
		public $providers = [
			...
			'vkontakte' => ['title' => 'Вконтакте', 'enabled' => false],
			'facebook' => ['title' => 'Facebook', 'enabled' => false],
			'google' => ['title' => 'Google Accounts', 'enabled' => true],
			'openid' => ['title' => 'OpenID', 'enabled' => false],
			'myopenid' => ['title' => 'MyOpenID', 'enabled' => false],
			'twitter' => ['title' => 'Twitter', 'enabled' => false],
			'rambler' => ['title' => 'Rambler', 'enabled' => false],
			'mailru' => ['title' => 'Mail.ru', 'enabled' => true],
 			'mailruapi' => ['title' => 'Mail.ru', 'enabled' => false],
			'loginza' => ['title' => 'Loginza', 'enabled' => false],
			'webmoney' => ['title' => 'WebMoney', 'enabled' => false],
			'flickr' => ['title' => 'flickr', 'enabled' => false],
			'lastfm' => ['title' => 'lastfm', 'enabled' => false],
