<?php
	...
	class umiInstallExecutor {
		...
		private function getDummyInfo() {
			...
			$ht['allow_array'] = [
				...
				'smu/installer.php',
				'umi_smt.php',
				'styles/skins/modern/design/js/common/html/UpdatesPreloader.html',
				'styles/skins/modern/design/img/updating_preloader.gif',
				'styles/skins/modern/design/js/common/html/UpdatesErrorMessage.html',
				'styles/skins/modern/design/js/common/html/UpdatesInvalidResponseMessage.html',
			];
			return $ht;
		}
	...
	class umiUpdateDownloader {
		 ...
		 * @throws Exception
		 */
		public function __construct($destination, $key, $host, $ip, $currentRevision = umiInstallExecutor::NEWEST_VERSION_ID,
			$targetRevision = umiInstallExecutor::NEWEST_VERSION_ID) {
