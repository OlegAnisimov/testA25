...
<xsl:output method="html" encoding="utf-8" indent="yes" doctype-public="-//W3C//DTD XHTML 1.0 Strict//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd" />
			...
			<head>
				...
				<style>
					...
					div.container div.basket_info {
						...
						width: 150px;
						padding-left: 30px;
						background: url(/styles/common/xsl/social/basket.png) no-repeat;
					}
				...
				<script type="text/javascript" src="/styles/common/js/node_modules/jquery/dist/jquery.js" charset="utf-8"></script>
				<script type="text/javascript" src="/styles/common/js/node_modules/jquery-migrate/dist/jquery-migrate.js" charset="utf-8"></script>
				<script type="text/javascript" src="/styles/common/js/site/__common.js" charset="utf-8"></script>
			</head>
			<body>
				<div class="container">
		...
		<xsl:call-template name="thumbnail">
			...
			<xsl:with-param name="src">
				<xsl:choose>
					...
					<xsl:otherwise>/styles/common/xsl/social/nofoto.jpg</xsl:otherwise>
				</xsl:choose>
			</xsl:with-param>
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:include href="custom/vkontakte.xsl" />
