	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<script type="text/javascript" src="/styles/common/js/node_modules/jquery/dist/jquery.js?{$system-build}" charset="utf-8" />
				<script type="text/javascript" src="/styles/common/js/node_modules/jquery-migrate/dist/jquery-migrate.js?{$system-build}" charset="utf-8" />
				<script type="text/javascript" src="/styles/common/js/jquery/jquery-ui.js?{$system-build}" charset="utf-8" />
				<script type="text/javascript" src="/styles/common/js/jquery/jquery.umipopups.js?{$system-build}" charset="utf-8" />
				<script type="text/javascript" src="/styles/common/js/jquery/jquery.contextmenu.js?{$system-build}" charset="utf-8" />
				...
				<xsl:if test="/result/data[@type = 'list']">
					<script	type="text/javascript" src="/styles/skins/modern/design/js/smc/compressed.min.js?{$system-build}"></script>
				</xsl:if>

				<!-- umi ui css -->
				<link type="text/css" rel="stylesheet" href="/styles/common/css/compiled.min.css?{$system-build}"/>
