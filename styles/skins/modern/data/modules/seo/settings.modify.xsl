					...
					<div class="column">
						<form method="post" action="do/" enctype="multipart/form-data">
							<div class="panel-settings">
								<div class="title">
									<h3><xsl:text>&label-seo-empty-meta-tags-settings;</xsl:text></h3>
								</div>
								<div class="content">
									<xsl:apply-templates select="group[@name = 'empty-meta-tags']/option" mode="settings.modify" />
								</div>
								<div class="title">
									<h3><xsl:text>&header-seo-domains;</xsl:text></h3>
								</div>
								<div class="content">
									<xsl:apply-templates select="group[@name != 'empty-meta-tags']" mode="settings-modify" />
								</div>
							</div>
							<div class="row">
