...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="entities.table.control">
		...
		<script src="/styles/common/js/node_modules/backbone/backbone-min.js?{$system-build}"/>
		<script src="/styles/common/js/node_modules/twig/twig.min.js?{$system-build}"/>
		<script src="/styles/common/js/node_modules/backbone-relational/backbone-relational.js?{$system-build}"/>
		<script src="/styles/common/js/node_modules/backbone.marionette/lib/backbone.marionette.min.js?{$system-build}"/>
