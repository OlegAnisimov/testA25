	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<script type="text/javascript" src="/styles/common/js/node_modules/jquery-migrate/dist/jquery-migrate.js?{$system-build}" />
			...
			<body>
				...
				<script src="/styles/skins/modern/design/js/tickets.js?{$system-build}" />
			</body>
		</html>
	</xsl:template>
