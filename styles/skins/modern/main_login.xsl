...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<html>
			...
			<body>
				...
				<script type="text/javascript" src="/styles/common/js/node_modules/jquery/dist/jquery.js" />
				<script type="text/javascript" src="/styles/common/js/node_modules/jquery-migrate/dist/jquery-migrate.js" />
				<script type="text/javascript" src="/styles/skins/modern/design/js/selectize.min.js" />
				<script type="text/javascript" src="/ulang/{$lang-prefix}/common/?js" charset="utf-8" />
				<script type="text/javascript" src="/styles/skins/modern/design/js/mainLogin.js" />
			</body>
		</html>
	</xsl:template>
		...
		<form action="{$lang-prefix}/admin/users/login_do/" method="post">
			...
			<div class="row">
				...
				<div class="col-md-6 last">
					<label>
						<div class="checkbox">
							<input type="checkbox" name="save-auth-token" class="checkbox" value="1"/>
						</div>
						<span class="label">
							<acronym><xsl:text>&label-login-store;</xsl:text></acronym>
						</span>
					</label>
				</div>
			</div>
	...
	<xsl:template name="mainRestorePasswordForm">
		<form id="forget" action="{$lang-prefix}/users/forget_do/" method="post">
			...
			<div class="row reset_container" style="display: none">
				<div class="col-md-12">
					<div id="resetFormAnswer" />
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6 last">
						<input type="submit" id="submit_reset_field" value="&forget-button;" class="btn color-blue btn-small" />
					</div>
				</div>
