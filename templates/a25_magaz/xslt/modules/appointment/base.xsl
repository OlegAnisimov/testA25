...
<xsl:stylesheet	version="1.0"
	...
	<xsl:template match="/result[@module = 'appointment' and @method = 'page']">
		...
		<script src='/templates/a25_magaz/js/appointment/lib/moment.js' type="text/javascript"></script>
		<script src='/templates/a25_magaz/js/appointment/lib/jQuery.hoverForMore.js' type="text/javascript"></script>
		<script src='/templates/a25_magaz/js/appointment/lib/jQuery.inputmask.js' type="text/javascript"></script>
		<script src='/templates/a25_magaz/js/appointment/lib/ru.js' type="text/javascript"></script>
		<script src='/templates/a25_magaz/js/appointment/lib/underscore.js' type="text/javascript"></script>
		<script src='/templates/a25_magaz/js/appointment/lib.js' type="text/javascript"></script>

		<div class="appointments main-container">
			<script src='/templates/a25_magaz/js/appointment/main.js' type="text/javascript"></script>
			<div id="wrapper">
						...
						<div class="online-entry__content">
							<div class="column-60pct">
								<div class="service-choose">
									<img id="service-loader" src="/templates/a25_magaz/images/appointments/loader.gif" />
								</div>
							</div>
			...
			<script src='/templates/a25_magaz/js/appointment/datepicker.js' type="text/javascript"></script>
		</div>
	</xsl:template>
</xsl:stylesheet>